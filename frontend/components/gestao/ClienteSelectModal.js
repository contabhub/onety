      ...
      >
        ...
        <div style={{
          ...
          <div style={{
            ...
            {selecionados.length} de {clientes.length} cliente(s) selecionado(s)
          </div>
          <button
            onClick={toggleTodos}
            style={{
        ...
        {/* Lista de Clientes */}
          ...
          {clientesFiltrados.length === 0 ? (
            <div style={{
              ...
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{ marginBottom: "var(--titan-spacing-sm)" }}>
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              padding: "var(--onity-space-s) var(--onity-space-m)",
              background: selecionados.length === 0 ? "var(--onity-color-border)" : "var(--onity-color-primary)",
...
export default ClienteSelecaoModal;
